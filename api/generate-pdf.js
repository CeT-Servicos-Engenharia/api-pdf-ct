...
class PDFContext {
    ...
    async addNewPage(options = {}) {
        ...
        // Adiciona cabeçalho e rodapé apenas se não for a primeira página ou se for explicitamente solicitado
        // Para evitar duplicação em páginas já existentes
        if (this.pageNumber > 1 || options.addHeaderFooter) {
