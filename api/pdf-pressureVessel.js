...
async function generatePDF(data, clientData, engenieerData, analystData) {
  ...
  // === Preenche o sumário com base nas entradas salvas ===
  summaryPage.drawText("SUMÁRIO", { x: 50, y: summaryY, size: 18, font: summaryFont });
  summaryY -= 30;
  for (const entry of summaryEntries) {
    summaryPage.drawText(`${entry.title} ..................................... ${entry.page}`, {
      x: 50,
      y: summaryY,
      size: 12,
      font: summaryFont,
